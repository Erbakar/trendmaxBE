...
COLORS GENERAL
	GENERAL COLORS
	- Main color: <?php echo $tema['t8']; ?>
	- Color Text General: #333333
	- Color Link: #333333
	- Color Link Hover: <?php echo $tema['t8']; ?>
	...
	- Color Price Text: <?php echo $tema['t8']; ?>
...
COLORS HEADER
	...
	- Background Header: <?php echo $tema['t8']; ?>
	- Color Text Top Header: #ffffff
	- Color Text Top Header Hover: #f7e245
	- Border Top Header: #ffffff
	- Background Top Header: <?php echo $tema['t8']; ?>
