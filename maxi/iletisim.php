...
<div class="container">
  ...
  <div class="row">
		...
		<div class="info-contact row">
			...
			<div class="col-sm-12 col-xs-12 contact-form" style="background:white;padding-top:10px;margin-bottom:20px;">    	<div class="row">                		<div class="col-md-4">                			<div class="contact-box text-center">        						<h3>İletişim Adresimiz</h3>        						<address><?php echo $ayar['adres']; ?></address>        					</div><!-- End .contact-box -->                		</div><!-- End .col-md-4 -->                		<div class="col-md-4">                			<div class="contact-box text-center">        						<h3>Müşteri Hizmetleri</h3>        						<div><a href="mailto:<?php echo $ayar['email']; ?>"><?php echo $ayar['email']; ?></a></div>        						<div><a href="tel:<?php echo $ayar['tel']; ?>"><?php echo $ayar['tel']; ?></a>, <a href="tel:<?php echo $ayar['ceptel']; ?>"><?php echo $ayar['ceptel']; ?></a></div>        					</div><!-- End .contact-box -->                		</div><!-- End .col-md-4 -->                		<div class="col-md-4">                			<div class="contact-box text-center">        						<h3>Sosyal Medya Hesaplarımız</h3>        		<div class="social-icons social-icons-color justify-content-center">			    <a <?php echo $ayar['facebook'] == '' ? 'style="display:none;"' : null; ?> href="<?php echo $ayar['facebook']; ?>" class="social-icon" target="_blank" title="Facebook"><i class="fa fa-facebook"></i></a>                <a <?php echo $ayar['twitter'] == '' ? 'style="display:none;"' : null; ?> href="<?php echo $ayar['twitter']; ?>" class="social-icon" target="_blank" title="Twitter"><i class="fa fa-twitter"></i></a>                <a <?php echo $ayar['pinterest'] == '' ? 'style="display:none;"' : null; ?> href="<?php echo $ayar['pinterest']; ?>" class="social-icon" target="_blank" title="pinterest"><i class="fa fa-pinterest"></i></a>                <a <?php echo $ayar['linkedin'] == '' ? 'style="display:none;"' : null; ?> href="<?php echo $ayar['linkedin']; ?>" class="social-icon" target="_blank" title="linkedin	"><i class="fa fa-linkedin"></i></a>                <a <?php echo $ayar['instagram'] == '' ? 'style="display:none;"' : null; ?> href="<?php echo $ayar['instagram']; ?>" class="social-icon" target="_blank" title="instagram"><i class="fa fa-instagram"></i></a>                <a <?php echo $ayar['youtube'] == '' ? 'style="display:none;"' : null; ?> href="<?php echo $ayar['youtube']; ?>" class="social-icon" target="_blank" title="youtube"><i class="fa fa-youtube"></i></a>                <a <?php echo $ayar['googleplus'] == '' ? 'style="display:none;"' : null; ?> href="<?php echo $ayar['googleplus']; ?>" class="social-icon" target="_blank" title="googleplus"><i class="fa fa-google-plus"></i></a>               </div><!-- End .soial-icons -->        					</div><!-- End .contact-box -->                		</div><!-- End .col-md-4 -->                	</div><!-- End .row -->
