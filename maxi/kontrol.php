                ...
                <div class="cart">
	                <div class="container">
	                	<div class="row">
			                        ...
			                        <h6 style="text-align: center;background: <?php echo $tema['t8'];?>;color:white;border-radius: 0.37rem;padding: 10px;">Üye Girişi</h6>
...
margin-top: -20px;" href="sifremiunuttum/" class="forgot-link">Şifremi Unuttum ?</a>
						...
						<div class="col-lg-4" style="background: white;border: 1px solid #ebe7e7;padding: 30px;border-right: none;">
						<h6 style="text-align: center;background: <?php echo $tema['t8'];?>;color:white;border-radius: 0.37rem;padding: 10px;">Misafir Alışverişi</h6>
						<div>
					...
					<h6 style="text-align: center;background: <?php echo $tema['t8'];?>;color:white;border-radius: 0.37rem;padding: 10px;">Üyelik Kaydı</h6>
                          <form action="" method="POST">
									    <input type="hidden" name="nereden" value="kontrol"/>
                                        <div class="form-group">
