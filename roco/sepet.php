...
<div class="fluid-container">
   <div class="container cart-container my-4">
	...
	<div class="form-group">
		...
		<div class="input-group" style="width: 100% !important;    margin-bottom: 10px !important;}">
			<input type="text" style="padding:0px !important;width: 80%;border-radius: 2px !important;" class="form-control" name="kuponadi" placeholder="İndirim Kuponu Kodunuz">
			<span class="input-group-append" style="height: 38px !important;display: block;"> 
				<button class="btn btn-primary" style="background:<?php echo $tema['t37'];?> !important;border:none;" type="submit" name="kuponguncelle">Kullan</button>
				                           ...
				                           <?php if ($_SESSION['uyegirisdurumu'] == 'true') { ?>
											...
											<select name="kuponadi" class="form-control" style="    width: 100%;background: #f9f9f9;margin-bottom: 10px;font-weight: 400;" onchange='this.form.submit()'>
