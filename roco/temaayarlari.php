...
if (isset($_POST['guncelle'])) {
  ...
  $t47 = "Kategori Anasayfa Resmi - (240x340)";
  ...
  if (!empty($_FILES['t12']['name'])) {
   ...
   $stmt = $ozy->prepare("UPDATE temalar SET t4 = ?, t5 = ?, t6 = ?, t7 = ?, t8 = ?, t10 = ?, t11 = ?, t13 = ?, t50 = ?, t49 = ?, t48 = ?, t47 = ?, t33 = ?, t35 = ?, t36 = ?, t37 = ?, t38 = ?, t29 = ?, t40 = ? WHERE id = ?");
   $result2 = $stmt->execute(array($t4, $t5, $t6, $t7, $t8, $t10, $t11, $t13, $t50, $t49, $t48, $t47, $t33, $t35, $t36, $t37, $t38, $t29, $t40, $id));
                    ...
                    <div class="card m-b-30">
		              ...
		              <input type="submit" name="submit" value="Temayı Yükle" class="btn btn-outline-primary waves-effect waves-light upload"> <br><br>
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="t40" type="color" value="<?php echo $sayfam['t40']; ?>" id="example-color-input">
                                </div>
                            </div>
					
					
					         <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Tema Üst Yazı Alanı</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Fırsat Ürünleri Sol Banner (404x173)</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Fırsat Ürünleri Sol Banner Linki</label>
                                <div class="col-sm-10">
								...
								<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Fırsat Ürünleri Orta Banner (404x173)</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Fırsat Ürünleri Orta Banner Linki</label>
                                <div class="col-sm-10">
								...
								<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Fırsat Ürünleri Sağ Banner (404x173)</label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Fırsat Ürünleri Sağ Banner Linki</label>
                                <div class="col-sm-10">
