...
<div class="wrapper">
        <div class="container-fluid">
                ...
                <div class="col-12">
			     <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                    <div class="card m-b-30">
                         ...
                         <!-- Nav tabs -->
                            <ul class="nav nav-pills nav-justified" role="tablist">
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-toggle="tab" href="#profile-1" role="tab">
                                        <span class="d-none d-md-block">Tema Ayarları</span><span class="d-block d-md-none"><i class="mdi mdi-folder-multiple-outline h5"></i></span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-toggle="tab" href="#messages-1" role="tab">
                                        <span class="d-none d-md-block">İletişim Ayarları</span><span class="d-block d-md-none"><i class="mdi mdi-guitar-pick-outline h5"></i></span>
                                    </a>
                                </li>
								
								 <li class="nav-item waves-effect waves-light">
                                    <a class="nav-link" data-toggle="tab" href="#messages-2" role="tab">
                                        <span class="d-none d-md-block">Sosyal Medya Ayarları</span><span class="d-block d-md-none"><i class="mdi mdi-format-align-justify h5"></i></span>
                                    </a>
                                </li>
                          ...
                          <div class="tab-pane active p-3" id="home-1" role="tabpanel">
                           ...
                           <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Site URL Adresiniz</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="siteurl" value="<?php echo $sayfam['siteurl']; ?>">
                                </div>
                            </div>
							
						   <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Site Değişen Title</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="dtitle" value="<?php echo $sayfam['dtitle']; ?>">
                                </div>
                            </div>
							...
							<div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="siteadi" value="<?php echo $sayfam['siteadi']; ?>">
                                </div>
                            </div>
							
							
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Site Özel Keyword</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" data-role="tagsinput" name="sitekey" value="<?php echo $sayfam['sitekey']; ?>">
                                </div>
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Site Özel Açıklaması</label>
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="6" name="sitedesc"><?php echo $sayfam['sitedesc']; ?></textarea>  
                                </div>
						...
						<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Bakım Modu</label>
                                <div class="col-sm-10">
                                <input type="checkbox" <?php if($sayfam['bakimdurum'] == '1') {?> checked="" <?php } ?> value="1" data-toggle="toggle" data-onstyle="primary" data-offstyle="secondary" name="bakimdurum"></div>
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Bakım Modu Metni</label>
                                <div class="col-sm-10">
                                <textarea id="summernote" rows="6" name="bakim"><?php echo $sayfam['bakim']; ?></textarea>
								</div>
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Google Analytics Kodu</label>
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="6" name="google"><?php echo $sayfam['google']; ?></textarea>  
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Yandex Kodu</label>
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="6" name="yandex"><?php echo $sayfam['yandex']; ?></textarea>  
                                </div>
                                            
                            </div>	

                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Reklam Kodu</label>
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="6" name="reklam"><?php echo $sayfam['reklam']; ?></textarea>  
                                </div>
							 ...
							 <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Robots.txt Kodu</label>
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="8" name="t4"><?php echo $sayfam['t4']; ?></textarea>  
                                </div>
                           ...
                           <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Google Maps Kodu</label>
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="6" name="maps"><?php echo $sayfam['maps']; ?></textarea>  
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Copyright Metni</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="copy" value="<?php echo $sayfam['copy']; ?>">
                                </div>
                            </div>
            ...
            <div class="tab-pane p-3" id="profile-1" role="tabpanel">
							...
							<div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Site Teması</label>
                            <div class="col-sm-10">
                            <?php $tmlr = $ozy->query("select * from temalar")->fetchAll(PDO::FETCH_ASSOC); 
                            foreach($tmlr as $tm){?>
                            <div style="float: left;
  margin-right: 10px;">
						   <input style="position: absolute;margin-left:10px;margin-top: 64px;" id="demo-inline-form-radio-<?php echo $tm['adi']; ?>" class="magic-radio" name="tema"
                            value="<?php echo $tm['adi']; ?>" <?php echo $sayfam['tema'] == $tm['adi'] ? 'checked=""' : null; ?>
                            type="radio">
                            <label style="border: 1px solid #e4e4e5;border-radius: 2px;text-align: center;" for="demo-inline-form-radio-<?php echo $tm['adi']; ?>"><img  style="height: 60px;width: 100px;" src="../<?php echo $tm['adi']; ?>/<?php echo $tm['temaresim']; ?>"></br><?php echo $tm['adi']; ?></img></label>
                           </div>
							<?php } ?>
							     		...
							     		<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Site Favicon</label>
                                <div class="col-sm-10">
									...
									<img src="../resimler/siteayarlari/<?php echo $sayfam['favicon']; ?>" style="width: 200px; height: 200px;" alt="" />
									...
									<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Site Logosu</label>
                                <div class="col-sm-10">
									...
									<img src="../resimler/siteayarlari/<?php echo $sayfam['logo']; ?>" style="width: 200px; height: 200px;" alt="" />
							...
							<div class="form-group row">
                                <label for="example-tel-input" class="col-sm-2 col-form-label">Telefon Numaranız</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="tel" value="<?php echo $sayfam['tel']; ?>" id="example-tel-input"  name="tel">
                                </div>
                            </div>
						
							<div class="form-group row">
                                <label for="example-tel-input" class="col-sm-2 col-form-label">Gsm Numaranız</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="tel" value="<?php echo $sayfam['ceptel']; ?>" id="example-tel-input"  name="ceptel">
                                </div>
                            </div>
							
                            <div class="form-group row">
                                <label for="example-tel-input" class="col-sm-2 col-form-label">WhatsApp Numaranız</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="tel" value="<?php echo $sayfam['whatsapp']; ?>" id="example-tel-input"  name="whatsapp">
                                </div>
                            </div>
							
							
							   <div class="form-group row">
                                <label for="example-tel-input" class="col-sm-2 col-form-label">Email Adresiniz</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" value="<?php echo $sayfam['email']; ?>" name="email">
                                </div>
                            </div>


							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">İletişim Adresi</label>
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="6" name="adres"><?php echo $sayfam['adres']; ?></textarea>  
                                </div>
					...
					<div class="form-group">
                     ...
                     <input class="form-control" name="facebook" value="<?php echo $sayfam['facebook']; ?>" type="text">
                     </div>
					 </div>
                     ...
                     <input class="form-control" name="twitter" value="<?php echo $sayfam['twitter']; ?>" type="text">
                     </div>
					 </div>
                    ...
                    <input class="form-control" name="instagram" value="<?php echo $sayfam['instagram']; ?>" type="text">
                    </div>
					</div>
					...
					<div class="form-group">
                     ...
                     <input class="form-control" name="googleplus" value="<?php echo $sayfam['googleplus']; ?>" type="text">
                     </div>
					 </div>
                     ...
                     <input class="form-control" name="pinterest" value="<?php echo $sayfam['pinterest']; ?>" type="text">
                     </div>
					 </div>
                     ...
                     <input class="form-control" name="linkedin" value="<?php echo $sayfam['linkedin']; ?>" type="text">
                     </div>
					 </div>
                     ...
                     <input class="form-control" name="youtube" value="<?php echo $sayfam['youtube']; ?>" type="text">
                     </div>
					 </div>
