                ...
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
	                       ...
	                       <?php $pr = $ozy->query("select * from tumyorumlar where konu='urunler' ORDER BY id DESC")->fetchAll(PDO::FETCH_ASSOC);
                           foreach ($pr as $tr) {?>	
                                ...
                                <tr>
									...
									<a href="urun-yorumlari?temizle=<?php echo $tr['id'];  ?>" onclick="return confirm('Silmek istediğinize emin misiniz ?')" class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Sil"><i class="ti-trash" aria-hidden="true"></i></a>									 
