					  ...
					  foreach ($uyesepeti as $sepet) {?>
										...
										<tr>
										 <td class="product-col">
			                                ...
			                                <input type="text" onchange="this.form.submit()" name="adet" value="<?php echo $newstok;?>" min="1" max="<?php echo $sepet['stok'];?>"  size="2" id="input-quantity" class="form-control" required>
                                            <?php } else { ?>
                                            <input type="text" onchange="this.form.submit()" name="adet" value="<?php echo $newstok;?>" min="1" max="9999999999999999999" size="2" id="input-quantity" class="form-control" required>
                                            <?php } ?>
	                		...
	                		<aside class="col-lg-3" style="background: white;">
	                			<div class="summary summary-cart" style="background: white !important;">
	                				<h3 style="padding-left: 67px;font-size: 17px;padding-top: 5px;" class="summary-title">Ödeme Detayları</h3><!-- End .summary-title -->
