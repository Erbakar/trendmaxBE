                ...
                <div class="card-body cart">
					...
					<img style="margin: auto !important;" src="eklentiler/sepetbos.png" width="100" height="100" class="img-fluid mb-4 mr-3">
            			...
            			<form action="alisverisi-tamamla/" method="POST"/>
		                	<div class="row">
		                		<div class="col-lg-9" style="border: 1px solid #f8f8f8;border-radius: 4px;background: white;">
		                			<h2 class="checkout-title" style="font-size: 17px;">Sipariş Detayları</h2><!-- End .checkout-title -->
		                				<div class="row">
							...
							<aside class="col-lg-3" style="background: white;">
								<div class="summary summary-cart" style="background: white !important;">
	                				<h3 class="summary-title" style="font-size: 17px;">Ödeme Detayları</h3><!-- End .summary-title -->
	                					...
	                					<tbody>
                                           ...
                                           <?php if($cekindirim!='0'){?>
	                						...
	                						<tr class="summary-total" >
	                							...
	                							<td id="toplam-price-val" style="color: #fa5616;font-size: 18px;font-weight: bold;"  data-price="<?php echo $toplamtutarim;?>"><?php echo $toplamtutari;?></td>
		                			...
		                			<div class="summary">
		                				<h3 class="summary-title" style="font-size: 17px;">Ödeme Yöntemleri</h3><!-- End .summary-title -->
                                        ...
                                        <div id="paymentOptions">
                                         ...
                                         <i style="color: #ff6f38;"  class="fa fa-university" aria-hidden="true"></i> <span class="details credit">Havale/EFT</span>
                                         </li>
										 <?php } ?>
                                         ...
                                         <span class="radio"><input onclick="kapidaodemeekle(1)" type="radio" name="odemetipi" value="Kapıda Ödeme" required><label></label></span>
                                          <i style="color: #ff6f38;"  class="fa fa-truck" aria-hidden="true"></i> <span class="details credit">Kapıda Ödeme <b>+ <?php echo fiyatgoster($system['kapitutar']);?></b></span>
                                         </li>
										 <?php } ?>
                                         ...
                                         <span class="radio"><input onclick="kapidaodemeekle(0)" type="radio" name="odemetipi" value="Kredi Kartı" required><label></label></span>
                                          <i style="color: #ff6f38;"   class="fa fa-credit-card" aria-hidden="true"></i> <span class="details credit"> Kredi Kartı</span>
                                         </li>
										 <?php } ?>
