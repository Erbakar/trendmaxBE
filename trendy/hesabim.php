	                	...
	                	<div class="row">
	                		...
	                		<div class="col-md-10 col-lg-10">
	                			<div class="tab-content">
								    <div style="margin-bottom:20px;" class="tab-pane fade show active" id="tab-dashboard" role="tabpanel" aria-labelledby="tab-dashboard-link">
								    	...
								    	<br>
								    	Dilersen buradan <a class="nav-link" id="tab-orders-link" data-toggle="tab" href="#tab-orders" role="tab" aria-controls="tab-orders" aria-selected="false" aria-expanded="true">tüm siparişlerinizi görebilir</a>, veya <a class="nav-link" id="tab-address-link" data-toggle="tab" href="#tab-address" role="tab" aria-controls="tab-address" aria-selected="false">kayıtlı adreslerinizi görebilir </a>, veya 										<a class="nav-link" id="tab-account-link" data-toggle="tab" href="#tab-account" role="tab" aria-controls="tab-account" aria-selected="false" aria-expanded="false">üyelik bilgilerinizi güncelleyebilirsiniz.</a>																				</p>
								    </div><!-- .End .tab-pane -->
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title" style="margin-top: 10px;">
                    <a style="font-size: 14px;margin-top: 10px;color: #888181;font-weight: 500;padding-left: 60px;" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $sip['siparisno'];?>">
...
$ceksay = $ceksorgu->fetchColumn(); ?>
		...
		?>				
				   ...
				   <?php }
							...
							<div class="col-sm-12" id="kurumsal" style="<?php echo $uyebilgileri['uyetip'] == '1' ? 'display:block !important;' : null; ?>display:none;">			
						    <div class="md-form md-outline">
							...
							<div class="col-sm-12" id="kurumsal2" style="<?php echo $uyebilgileri['uyetip'] == '1' ? 'display:block !important;' : null; ?>display:none;">			
						    <div class="md-form md-outline">
							...
							<div class="col-sm-12" id="kurumsal3" style="<?php echo $uyebilgileri['uyetip'] == '1' ? 'display:block !important;' : null; ?>display:none;">			
						    <div class="md-form md-outline">
