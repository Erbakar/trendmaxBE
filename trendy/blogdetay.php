...
<div class="page-content">
                ...
                <div class="container">
                    ...
                    <?php if($urunyorumsayimis>'0'){?>
                        <h4 class="title"><?php echo $urunyorumsayimis;?> Yorum</h4><!-- End .title -->
                    <?php } else { ?>
					<h4 class="title">Bu yazıya henüz yorum yapılmamış. İlk yorumu sen yapmak ister misin ?</h4><!-- End .title -->
					<?php } ?>	
                ...
                foreach ($deneme as $blogyorum) {?>			
                    ...
                    <div class="reply">
                        ...
                        <form action="" method="POST">
                            ...
                            <button type="submit" name="blogyorum" class="butonok btn btn-outline-primary-2">
