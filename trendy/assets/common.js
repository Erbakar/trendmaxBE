...
$(document).ready(function() {
	...
	$('#search input[name=\'search\']').parent().find('button').on('click', function() {
		...
		/* Search */
	$('#search input[name=\'searchm\']').parent().find('button').on('click', function() {
		var url = $('base').attr('href') + 'index.php?route=product/search';

		var value = $('header #search input[name=\'searchm\']').val();

		if (value) {
			url += '&searchm=' + encodeURIComponent(value);
		}
...
/* Quatity buttons */
	...
	$('#search input[name=\'searchm\']').on('keydown', function(e) {
		if (e.keyCode == 13) {
			$('header #search input[name=\'searchm\']').parent().find('button').trigger('click');
		}
	});
	// Menu
