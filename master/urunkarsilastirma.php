	   ...
	   <div class="kategori1">
        <div class="div-block-linkler-divbox">
            <div class="div-block-linkler">
                ...
                <a href="javascript:;" class="link-12">Ürün Karşılaştırma</a>
            </div>
        </div>
        <div class="div-block-4461292330">
            <div class="w-row">
                ...
                <div class="column-188 w-col w-col-12">
                    ...
                    <div class="w-row">
              <div class="w-col w-col-12 w-col-tiny-12">
...
<table>
  ...
  <tr>
    ...
    <td><span class="txt-l">
     <div class="newfiyat">
    <?php echo urunfiyatbelirle($karsilastirma['kdv'],$karsilastirma['idurum'],$karsilastirma['fiyat'],$karsilastirma['ifiyat']);?>
   ...
   <tr>
	...
	foreach ($uyesepeti1 as $karsilastirma) {?>
	<td><span>
    <a href="urun/<?php echo $karsilastirma['seo']; ?>" class="w-button newbuton" title="Ürünü İncele"><span>Ürünü İncele</span></a>
