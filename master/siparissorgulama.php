...
<meta property="og:description" content="<?php echo $ayar['sitedesc']; ?>"/>
	   ...
	   <div class="kategori1">
        <div class="div-block-linkler-divbox">
            <div class="div-block-linkler">
                ...
                <a href="javascript:;" class="link-12">Sipariş Sorgulama</a>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12" id="divYazdir">
									...
									<div class="row" style="text-align: center;background: #f1f1f1;border-radius: 4px;">
   ...
   <?php }
					...
					<div class="row" style="margin-top: 15px;background: white;padding: 20px;">
                    ...
                    <h4 class="heading-50">Sipariş Sorgulama</h4>
							...
							<input name="sipno" placeholder="Sipariş Numaranız" type="text" class="text-field-10---35-copy w-input" required>
		                			...
		                			<button type="submit" name="siparissorgulama" class="gributton text-center">
