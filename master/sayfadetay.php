...
<div class="kategori1">
    <div class="div-block-linkler-divbox">
      <div class="div-block-linkler">
                ...
                <a class="link-12">İşlem Rehberi</a><i class="fa fa-angle-right" aria-hidden="true"></i>
        ...
        <div class="column-190 w-col w-col-3 w-col-stack">
          <div class="div-block-4461292332">
            <div class="div-block-4461292339">
              <h4 class="heading-50">İşlem Rehberi</h4>
            </div>
           ...
           <?php $hzmetler1 = $ozy->query("select * from sayfalar where durum='1'order by sira desc")->fetchAll(PDO::FETCH_ASSOC); 
                            foreach($hzmetler1 as $hizmetler11){?>	
                            <a  class="link-9-2 <?php echo $page['id'] == $hizmetler11['id'] ? 'kurumsalaktif' : null; ?>" href="sayfa/<?php echo $hizmetler11['seo']; ?>"><strong class="bold-text-24" <?php echo $page['id'] == $hizmetler11['id'] ? 'style="font-weight:bold !important;"' : null; ?>><?php echo $hizmetler11['adi']; ?></strong></a>
							<?php } ?>
