...
<div class="kategori1">
        <div class="div-block-linkler-divbox">
            <div class="div-block-linkler">
			   ...
			   <a href="gununfirsati/" class="link-12">Fırsat Ürünleri</a>
                    ...
                    <div class="div-block-4461292333" style="margin-top:0;  margin-left: 0px !important;">
                        <div class="columns-38 w-row">
                            <div class="column-191 w-col w-col-8 w-col-tiny-tiny-stack">
                                <div>
                                    <div class="text-block-138"><strong style="color: #ff0000">Süper Fırsat ürünleri</strong> kategorisinde <strong style="color: #ff0000"><?php $katsorgu = $ozy->prepare("SELECT COUNT(*) FROM urunler where durum='1' and firsat='1'");
 ...
 <button style="width: 100%;margin-top: 10px;height: 38px;line-height: 13px;text-align: left;padding: 10px;font-size: 14px;background: <?php echo $tema['t37'];?>;" onclick="myFunction()" class="search-button-2 w-button dropbtn mobilgoster">Ürün Filtreleme</button>
							 ...
							 $pages = intval(@$_GET['pages']);
										...
										if (isset($_GET["siralama"]) && $_GET["siralama"] != "") {
											...
											if(temizle($_GET["siralama"]=='dusukfiyat')){
												...
												$pageoku = $ozy->query("select *, if( idurum=1,ifiyat,fiyat) AS simdikifiyat from urunler where durum='1' and firsat='1' ".$where." ".$wherex." ".$marka." order by simdikifiyat ASC limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC);
												...
												$pageoku = $ozy->query("select *, if( idurum=1,ifiyat,fiyat) AS simdikifiyat from urunler where durum='1' and firsat='1' ".$where." ".$wherex." ".$marka." order by simdikifiyat DESC limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC);
												...
												$pageoku = $ozy->query("select * from urunler where durum='1' and firsat='1' ".$where." ".$wherex." ".$marka." order by yorum DESC limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC);
												...
												$pageoku = $ozy->query("select * from urunler where durum='1' and firsat='1' ".$where." ".$wherex." ".$marka." order by hit DESC limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC);
												...
												$pageoku = $ozy->query("select * from urunler where durum='1' and firsat='1' ".$where." ".$wherex." ".$marka." order by tarih DESC limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC);
												...
												$pageoku = $ozy->query("select * from urunler where durum='1' and firsat='1' ".$where." ".$wherex." ".$marka." order by tarih ASC limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC);
												...
												$pageoku = $ozy->query("select * from urunler where durum='1' and firsat='1' ".$where." ".$wherex." ".$marka." order by sira DESC limit $goster,$limit")->fetchAll(PDO::FETCH_ASSOC);
	...
	<div class="notfound_container text-center" style="padding: 40px;font-weight: 500;">
		...
		<div class="notfound_content">
			...
			<div class="text fs-5 fw-bold mt-1"><a href="gununfirsati/">Tekrar denemek ister misin ?</a></div>
		</div>
	</div>													
															...
															for ($i= $pages - $forlimit ; $i < $pages + $forlimit + 1 ; $i++) { 
																...
																if ($i>0 and $i<=$sayfasayisi) {
																	...
																	if ($i == $pages) {
																		...
																		echo "<a class='button-18-aktif w-button' href='gununfirsati/?pages=".$i.$eklenecekstr."'>".$i."</a></li>";
