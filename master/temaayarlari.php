...
if (isset($_POST['guncelle'])) {
  ...
  $t47 = "Kategori Anasayfa Resmi - (675X315)";
  ...
  if (!empty($_FILES['t12']['name'])) {
   ...
   $stmt = $ozy->prepare("UPDATE temalar SET t4 = ?, t5 = ?, t6 = ?, t7 = ?, t8 = ?, t10 = ?, t11 = ?, t13 = ?, t50 = ?, t49 = ?, t48 = ?, t47 = ?, t33 = ?, t35 = ?, t36 = ?, t37 = ?, t38 = ?, t29 = ?, t40 = ?, t14 = ? WHERE id = ?");
   $result2 = $stmt->execute(array($t4, $t5, $t6, $t7, $t8, $t10, $t11, $t13, $t50, $t49, $t48, $t47, $t33, $t35, $t36, $t37, $t38, $t29, $t40, $t14, $id));
			     ...
			     <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                    <div class="card m-b-30">
		              ...
		              <input type="submit" name="submit" value="Temayı Yükle" class="btn btn-outline-primary waves-effect waves-light upload"> <br><br>
					   ...
					   <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Google Analytics UA Numaranız</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
					         ...
					         <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Ürünler Alt Yazı Alanı</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <textarea id="summernote" class="form-control" rows="6" name="t29"><?php echo $sayfam['t29']; ?></textarea>  
                                </div>
