	   ...
	   <div class="kategori1">
        <div class="div-block-linkler-divbox">
            <div class="div-block-linkler">
                ...
                <a href="javascript:;" class="link-12">Hesabım</a>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title" style="margin-top: 10px;height: 38px;">
                    <a style="font-size: 14px;margin-top: 10px;color: #888181;font-weight: 500;padding-left: 5px;" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $sip['siparisno'];?>">
...
height: 100px;" src="resimler/siteayarlari/<?php echo $ayar['logo'];?>" alt="logo" height="24">
									...
									<div class="row" style="text-align: center;background: #f1f1f1;padding: 10px;border-radius: 4px;">
...
height: 100px;" src="resimler/siteayarlari/<?php echo $ayar['logo'];?>" alt="logo" height="24">
			...
			<textarea name="mesaj"  class="text-field-10---35-copy w-input" cols="30" rows="4" id="cmessage" required></textarea>
...
$ceksay = $ceksorgu->fetchColumn(); ?>
		                   ...
		                   <?php }
                            ...
                            <textarea name="adres" class="text-field-10---35-copy w-input" cols="30" rows="4" placeholder="" required></textarea>
		...
		?>				
								    		...
								    		<div class="col-lg-6">
								    			<div class="card card-dashboard">
								    				<div class="card-body" style="border: 1px solid #e7e7e7;">
				   ...
				   <?php }
                            ...
                            <textarea name="mesaj" class="text-field-10---35-copy w-input" cols="30" rows="4" placeholder="" required></textarea>
