<?php if($_POST['odemetipi']=='Havale/EFT'){?>

<?php $metnim = '<strong>Dilerseniz tüm banka hesaplarımıza buradan ulaşabilirsiniz.</strong> <a target="_blank" href="'.$url.'/bankabilgilerimiz/"><br>Banka Hesaplarımız</a><br>
Hesaplarımızdan herhangi birine ödemeye yaparak iletişim formundan bize bildirebilirsiniz.</br>';?>

<?php }elseif($_POST['odemetipi']=='Kapıda Ödeme'){?>
<?php $metnim = '<strong>Dilerseniz tüm banka hesaplarımıza buradan ulaşabilirsiniz.</strong> <a target="_blank" href="'.$url.'/bankabilgilerimiz/"><br>Banka Hesaplarımız</a><br>';?>
						...
						<td valign="top" class="side title" style="border-collapse: collapse;border: 0;margin: 0;padding: 20px;-webkit-text-size-adjust: none;color: #555559;font-size: 16px;line-height: 26px;vertical-align: top;background-color: white;border-top: none;">
							<table style="font-weight: normal;border-collapse: collapse;border: 0;margin: 0;padding: 0;">
								...
								<tr>
									...
									Sayın, '.$adsoyad.'	Siparişinizi başarıyla aldık :)
									</div></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<img style="margin-bottom: 10px;" class="top-image" src="'.$url.'/mail/webinar-no-text.png" width="560"/>
										...
										<strong>Ödeme Yöntemi :</strong> '.$odemetipi.'<br>
										<strong>Toplam Ödenecek Tutar :</strong> '.fiyatgoster($toplamtutar).'<br>
										'.$metnim.'
