                ...
                <div class="cart">
	                <div class="container">
	                	<div class="row">
			                        ...
			                        <div class="col-lg-4" style="background: white;border: 1px solid #ebe7e7;padding: 30px;border-right: none;">
			                        <h6 style="text-align: center;background: <?php echo $tema['t37'];?>;color:white;border-radius: 0.37rem;padding: 10px;">Üye Girişi</h6>
...
float: right;
" href="sifremiunuttum/" class="forgot-link">Şifremi Unuttum ?</a>
						...
						<div class="col-lg-4" style="background: white;border: 1px solid #ebe7e7;padding: 30px;border-right: none;">
						<h6 style="text-align: center;background: <?php echo $tema['t37'];?>;color:white;border-radius: 0.37rem;padding: 10px;">Misafir Alışverişi</h6>
						<div>
						Dilerseniz sitemize üye olmadanda alışverişinizi hızlı bir şekilde tamamlayabilirsiniz.
						</br></br>
						<a href="odeme/"><h6  style="font-size: 12px;color: #fff;background: #222 !important;border: none;margin-top: 10px;text-align: center;background: #f8f8f8;padding: 10px;">ÜYELİKSİZ ALIŞVERİŞE DEVAM ET</h6></a></div>
						</div>
					...
					<div class="col-lg-4" style="background: white;border: 1px solid #ebe7e7;padding: 30px;">
					<h6 style="text-align: center;background: <?php echo $tema['t37'];?>;color:white;border-radius: 0.37rem;padding: 10px;">Üyelik Kaydı</h6>
                          <form action="" method="POST">
									    <input type="hidden" name="nereden" value="kontrol"/>
                                        <div class="form-group">
					...
					<?php } else { ?>	
					                ...
					                <div class="col-lg-6" style="background: white;border: 1px solid #ebe7e7;padding: 30px;">
			                        <h6 style="text-align: center;background: <?php echo $tema['t37'];?>;color:white;border-radius: 0.37rem;padding: 10px;">Üye Girişi</h6>
			                        <form action="" method="POST">
									<input type="hidden" name="nereden" value="kontrol"/>
                                        <div class="form-group">
