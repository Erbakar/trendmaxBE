...
<i class="fa fa-exclamation-circle"></i> <b>Ücretsiz Kargo </b>İçin Kalan Tutar: <b><?php echo $kalan = $system['ucretsizkargo']-$toplamtutarim;?> TL</b>
</div>
<?php } ?>
...
<tr style="border-bottom: 1px solid #e2dfdf;">
	...
	<td class="coll text-right"> 
		<form action="" method="POST">
										...
										<button name="delete" type="submit" class="btn-remove" style="background: #7c7878;
    color: white;
    border: none;" title="Sil">x</button>
                                        </form>	
	</td>
</tr>
	...
	<div class="form-group">
		...
		<div class="input-group">
			...
			<span class="input-group-append"> 
				<button class="btn btn-primary" style="background:<?php echo $tema['t8'];?>; !important;
    color: white;
    margin: 0px;
    height: 35px;
    line-height: 29px;
...
}" type="submit" name="kuponguncelle">Kullan</button>
			</span>
		</div>
	</div>
	</form>
...
<div class="card-body">
		...
		<hr>
		<?php if ($_SESSION['uyegirisdurumu'] == 'true') { ?>
	    <a href="odeme/" class="butonok btn btn-outline-primary-2">ÖDEME ADIMINA GEÇ</a>
	    <?php } else { ?>
		<a href="kontrol/"  class="butonok btn btn-outline-primary-2">ÖDEME ADIMINA GEÇ</a>
	    <?php } ?>
   ...
   right:!important;
    /* color: inherit; */
		...
		<a href="anasayfa" style="background: black;" class="btn btn-dark btn-block">ALIŞVERİŞE DEVAM</a>
</div> <!-- card-body.// -->
</div> <!-- card.// -->
