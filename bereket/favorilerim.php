      ...
      <div class="row">
         <nav data-depth="2" class="breadcrumb hidden-sm-down">
            <ol itemscope="" itemtype="http://schema.org/BreadcrumbList">
               ...
               <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                  <a itemprop="item">
                  <span itemprop="name">Favorilerim</span>
                  </a>
            ...
            <div class="laber-product-description">
			  ...
			  <div class="manufacturer_name">
               ...
               <div class="laber-product-price-and-shipping has_discount">
				...
				<a style="width: 100%;margin-top:20px;
background: black;
color: white;
position: absolute;padding: 10px;" title="Remove" class="color-red icon icon-clear" href="?favorilsil=<?php echo $katurunler['id']; ?>">
