...
text-align: center;
background: <?php echo $tema['t37'];?>;color:white;border-radius: 0.37rem;
padding: 10px;
    ...
    <div class="modal-content">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button style="background: <?php echo $tema['t37']; ?>;color: white;opacity: 1;font-size: 12px;padding: 10px;" type="button" class="butonok close" data-dismiss="modal" aria-hidden="true">Sözleşmeyi okudum ve kabul ediyorum.</button>
        </div>        
      </div>
    </div>
  </div>
