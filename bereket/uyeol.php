           ...
           <nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Üye Ol & Giriş Yap</li>
                    </ol>
                </div><!-- End .container -->
                ...
                <div class="cart">
	                <div class="container">
	                	<div class="row">
					                ...
					                <div class="col-lg-6" style="background: white;border: 1px solid #ebe7e7;padding: 30px;border-right:none;">
...
float: right;" href="sifremiunuttum/" class="forgot-link">Şifremi Unuttum ?</a>
