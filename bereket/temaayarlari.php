...
if (isset($_POST['guncelle'])) {
  ...
  $t8 = ($_POST['t37'] != "") ? $_POST['t37'] : "0";
  $t10 = ($_POST['t10'] != "") ? $_POST['t10'] : "0";
  $t11 = ($_POST['t11'] != "") ? $_POST['t11'] : "0";
  $t13 = ($_POST['t13'] != "") ? $_POST['t13'] : "0";
  $t50 = "display:none";
  $t49 = "Kategori Detay Resmi";
  $t48 = "Kategori Hikaye Resmi";
  $t47 = "Kategori Anasayfa Resmi - Bu temada kullanılamaz";
  ...
  if (!empty($_FILES['t12']['name'])) {
   ...
   $stmt = $ozy->prepare("UPDATE temalar SET t4 = ?, t5 = ?, t6 = ?, t7 = ?, t8 = ?, t10 = ?, t11 = ?, t13 = ?, t50 = ?, t49 = ?, t48 = ?, t47 = ?, t33 = ?, t35 = ?, t36 = ?, t37 = ?, t38 = ?, t29 = ? WHERE id = ?");
   $result2 = $stmt->execute(array($t4, $t5, $t6, $t7, $t8, $t10, $t11, $t13, $t50, $t49, $t48, $t47, $t33, $t35, $t36, $t37, $t38, $t29, $id));
...
<div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
			     <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
		              ...
		              <input type="submit" name="submit" value="Temayı Yükle" class="btn btn-outline-primary waves-effect waves-light upload"> <br><br>
							...
							<div class="form-group row">
					         ...
					         <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="t33" value="<?php echo $sayfam['t33']; ?>">
                                </div>
                            </div>   
						    
						<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Ürünlerin Genel Yükseklik Değeri ( Sadece Rakam )</label>
                                <div class="col-sm-10">
					...
					<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Anasayfa Yanyana Ürün Adeti ( Sadece Rakam )</label>
                                <div class="col-sm-10">
	        ...
	        <div class="form-group row">
            <label for="example-text-input" class="col-sm-2 col-form-label">Hikaye Durumu</label>
            <div class="col-sm-10">
            <input type="checkbox" <?php if($sayfam['t38'] == '1') {?> checked="" <?php } ?> value="1" data-toggle="toggle" data-onstyle="primary" data-offstyle="secondary" name="t38"></div>                                      
            </div>   
								...
								<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Anasayfa Sol Banner (404x173)</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
								...
								<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Anasayfa Orta Banner (404x173)</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
								...
								<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Anasayfa Sağ Banner (404x173)</label>
                                <div class="col-sm-10">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                  <textarea id="textarea" class="form-control" rows="6" name="t29"><?php echo $sayfam['t29']; ?></textarea>  
                                </div>
