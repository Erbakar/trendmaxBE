      	...
      	<nav aria-label="breadcrumb" class="breadcrumb-nav">
                <div class="container">
                    <ol class="breadcrumb">
					  ...
					  <li class="breadcrumb-item"><a href="bloglar/">Blog</a></li>
                    ...
                    <article class="entry single-entry entry-fullwidth">
                        <div class="row">
                            <div class="col-lg-12">
								...
								<img class="lazyload" style="width: 100%;" src="resimler/haberler/<?php echo $page['resim'];?>" alt="signature" class="mx-auto mb-5" <?php echo $page['resim'] == 'resimyok.jpg' ? 'style="display:none;"' : null; ?>>
...
padding-bottom: 10px;" class="title title-center">
                    ...
                    foreach($sayfaresimi as $genelresim){?>
						...
						<a data-lightbox="image-1" href="resimler/genel/<?php echo $genelresim['sayfaresim'];?>">		
                              <img class="lazyload"  style="width: 370px;height: 247px;" src="resimler/genel/<?php echo $genelresim['sayfaresim'];?>" alt="image" class="mx-auto mb-6"></div><!-- End .icon-box -->
                        </a>
