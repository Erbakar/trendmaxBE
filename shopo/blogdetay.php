                ...
                foreach ($deneme as $blogyorum) {?>			
                                ...
                                <div class="review">
                                        <div class="row no-gutters" style="padding:10px;">
                                            ...
                                            <div class="col">
                                               <h4 style="text-align: left;font-size: 15px;"><a><?php echo $blogyorum['adi']; ?></a></h4>
												...
												<div class="comment">
                                                    ...
                                                    <div class="comment-body">
                                                        <div class="comment-user">
                                                            <h6 style="text-align: left;"><a><?php echo $ayar['siteadi']; ?></a></h6>
...
width: 100%;" type="submit" name="blogyorum" class="btn btn-primary">
