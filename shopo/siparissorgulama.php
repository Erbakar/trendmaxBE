...
<div id="information-information" class="container">
   ...
   <?php }
	...
	<div class="col-sm-12" style="text-align: center;border: 1px solid #d4d2d2;padding: 10px;">
...
margin: 8px 0;
font-size: 14px;
background-color: #0cc51f;color:white;" type="submit" name="siparissorgulama" class="gributton text-center">
