...
<div id="information-information" class="container">
 ...
 <div class="container" style="padding: 0px;">
	                	...
	                	<div class="row">
	                		...
	                		<div class="col-md-9 col-lg-9" style="padding-right: 45px !important;">
                                ...
                                <div class="col-12" id="divYazdir" style="padding-left: 50px;">
                                    <div class="invoice-title">
                                        ...
                                        <h3 class="m-t-0" style="margin-bottom: -15px !important;">
                                            <img style="width: 150px;" src="resimler/siteayarlari/<?php echo $ayar['logo'];?>" alt="logo" height="24">
                                        </h3>
                                    </div>
                                    <hr>
                                    <div class="row">
...
.nav-item {
border-bottom: 4px solid <?php echo $tema['t37'];?>;
font-size: 14px;
