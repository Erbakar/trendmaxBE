...
padding-top: 10px;">
      ...
      <div class="row mb-3">
         <div class="col-sm-9 col-12 okey">
		  ...
		  <h2 class="checkout-title" style="margin-left: 2%;text-align: center;background: <?php echo $tema['t37'];?>;color:white;border-radius: 0.37rem;padding: 10px;font-size: 14px;margin-bottom:20px;">Sipariş Detayları</h2><!-- End .checkout-title -->
		                				<div class="row" style="margin-left: 15px !important;margin-right: 5px !important;">
							...
							<div class="col-sm-12">			
						    <div class="md-form md-outline" style="position: relative;
  z-index: 99;width: 48%;float: left;">
							...
							<div class="md-form md-outline" style="position: relative;
  z-index: 99;width: 48%;float: left;margin-left: 4%;">
							...
							<div class="col-sm-12">			
						    <div class="md-form md-outline" style="z-index: 99;
...
position: relative;width: 48%;float: left;margin-left: 4%;">
  ...
  z-index: 99;width: 48%;float: left;">
							...
							<div class="md-form md-outline" style="position: relative;
  z-index: 99;width: 48%;float: left;margin-left: 4%;display:none;" id="faturailce">	
