...
padding-top: 10px;
             ...
             <?php 
			 $urunyorumsayisiz = $ozy->prepare("SELECT COUNT(*) FROM kategoriler where durum='1' and ikongoster='1'");
             $urunyorumsayisiz->execute();
             $urunyorumsayimizzz = $urunyorumsayisiz->fetchColumn();?>
			 <?php 
			 $urunyorumsayisiz1 = $ozy->prepare("SELECT COUNT(*) FROM kampanyalar where durum='1'");
             $urunyorumsayisiz1->execute();
             $urunyorumsayimizzz1 = $urunyorumsayisiz1->fetchColumn();
			 $saysanahikaye = $urunyorumsayimizzz+$urunyorumsayimizzz1;
			 
			 ?>
			 
			 
   <div class="hikaye" <?php echo $saysanahikaye == '0' ? 'style="display:none;"' : null; ?>>
