...
<div id="product-category" class="container">
   ...
   <div id="content" class="col-sm-12">
      ...
      <div style="margin-bottom:25px;" class="row">
         <div class="col-sm-10">Favori Ürünlerim</div>
      </div>
      <hr>
	...
	$__URUN__ = false;
        ...
        $__URUN__ = true;
	                    ...
	                    ?>
		 		  	   ...
		 		  	   <div class="leftrightx col-lg-2 col-md-2 col-sm-12 col-xs-6">
                                                         ...
                                                         <div class="indirim">İndirim<br>
														    ...
														    <?php } ?>  
                                                               ...
                                                               <div class="button-group">
                                                                  ...
                                                                  <button data-toggle="tooltip" title="Sil" type="button" onclick="javascript:location.href='?favorilsil=<?php echo $katurunler['id']; ?>'"><i class="fa fa-trash"></i> Listeden Sil</button>
                                                               </div>
                                                            </div>
