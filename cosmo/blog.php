                        ...
                        <div class="store-content">
                            ...
                            <div class="seller-date">
							 <figure class="store-banner">
                                    <img style="  width: 100%;" src="resimler/haberler/<?php echo $blog['resim']; ?>" alt="Vendor">
                                </figure>
                                ...
                                <div class="store-address">
                                    <?php echo strip_tags(mb_substr($blog['aciklama'],0,300));?> ...
                                </div>
                                <a style="background: #777;color: white;border-radius: 4px;" href="<?php if($blog['link']=='0'){?>kampanya/<?php echo $blog['seo']; ?><?php } else { ?><?php echo $blog['link']; ?><?php } ?>" class="btn btn-dark btn-link btn-underline btn-icon-right btn-visit">
                                   Haber Detayı<i class="w-icon-long-arrow-right"></i></a>
                            </div>
                        </div>
