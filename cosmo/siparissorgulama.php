...
<meta property="og:description" content="<?php echo $ayar['sitedesc']; ?>"/>
   ...
   <?php }
	...
	<div class="col-sm-12 customer-login" style="text-align: center;border: 1px solid #d4d2d2;padding: 30px;">
					...
					<div class="div-block-4461292339-24" style="  width: 100%;">
                    <h4 class="title">Sipariş Sorgulama</h4>
                    </div>
							<div class="div-block-4461292339-24" style="  width: 100%;">			
						    
							<input style="width: 100%;" name="sipno" placeholder="Sipariş Numaranız" type="text" class="form-control w-input" required>
...
margin: 8px 0;
font-size: 14px;
background-color: #0cc51f;color:white;width: 100%;" type="submit" name="siparissorgulama" class="btn btn-primary">
