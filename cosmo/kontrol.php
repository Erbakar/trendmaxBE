				...
				<?php if($system['misafirok']=='1'){?>
				 ...
				 <div class="col-lg-4 col-md-6">
                    ...
                    <form  class="form-box login-form form-validator bv-form" action="" method="POST" enctype="multipart/form-data" style="background: white !important;">
                    	<input type="hidden" name="nereden" value="kontrol"/>
                      <div class="title-box">
                        <h2 class="h1 title">Misafir Girişi</h2>
                      </div>
                      <div class="row bottom-padding-xs">
                             <div class="col-xs-12 col-sm-12 col-md-12">
                        									     
					<img style="width: 100%;" src="<?php echo $sitetemasi;?>/user/misafir.png"></img>
...
padding: 15px;
margin: 8px 0;
font-size: 12px;" href="odeme/" class="btn btn-success">Üyeliksiz Devam Et</a>
						</div>
                        </div>
                      </div>
