...
<?php if ($_SESSION['uyegirisdurumu'] == 'true') { ?>
       ...
       <section class="py-4 bg-light inner-header">
        ...
        <section id="main" style="background:white !important;margin-top:20px;padding-top: 20px;">
          <div class="container">
	                	...
	                	<div class="row">
	                		<aside class="col-md-3 col-lg-3">
	                			<ul style="border: 20px solid #f6f6f6;border-radius: 2%;" class="nav nav-dashboard flex-column mb-3 mb-md-0" role="tablist">
								    <li class="nav-item">
	                		...
	                		<div class="col-md-9 col-lg-9">
	                			<div class="tab-content">
								    <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel" aria-labelledby="tab-dashboard-link">
								    	<p>Hoşgeldin Sayın <b style="text-transform: capitalize;"><?php echo $uyebilgileri['isim'];?></b> 
								    	<br>
 ...
 <div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title" style="margin-top: 10px;height: 38px;">
                    <a style="font-size: 14px;margin-top: 10px;color: #888181;font-weight: 500;padding-left: 40px;" class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $sip['siparisno'];?>">
			...
			foreach($dee as $see){?>
				...
				<?php if($see['durum'] =="3"){?>
					...
					<div class="group-button" >
						<b class="btn btn-outline-primary-2 btn-minwidth-sm">DESTEK KAPATILDIĞI İÇİN CEVAP VERİLEMEZ</b>
					</div>
				<?php }else {?>
					<div class="group-button" >
						<button class="btn btn-outline-primary-2 btn-minwidth-sm" type="submit" name="destekcevapla">CEVAPLA</button>
					</div>
				<?php }} ?>
...
$ceksay = $ceksorgu->fetchColumn(); ?>
		                   ...
		                   <?php }
								    ...
								    <div class="tab-pane fade" id="tab-address" role="tabpanel" aria-labelledby="tab-address-link">
								    	...
								    	<div class="row">
								    		...
								    		<div class="col-lg-6">
												...
												<h3 class="title" style="text-align: center;margin-top: 20px;">Adres Ekle</h3><!-- End .card-title -->
                            ...
                            <textarea name="adres" class="form-control" cols="30" rows="4" placeholder="" required></textarea>
						   ...
						   <input name="ilce" type="text"   class="form-control" required>
							...
							<button type="submit" name="adresekle" class="btn btn-outline-primary-2">
		...
		?>				
								    		...
								    		<div class="col-lg-6" style="">
								    			<div class="card card-dashboard">
								    				<div class="card-body" style="padding:15px;border: 1px solid #e7e7e7;">
								    					<h3 class="title"><?php echo $adres['adi'];?></h3><!-- End .card-title -->
				   ...
				   <?php }
							...
							<div class="col-lg-12">
							<div class="card card-dashboard">
							<h3 class="title" style="text-align: center;margin-top: 20px;">Destek Talebi Oluştur</h3><!-- End .card-title -->
							<div class="card-body" style="padding:2px !important;">    					
                            <form action="" method="POST">
                            ...
                            <textarea name="mesaj" class="form-control" cols="30" rows="4" placeholder="" required></textarea>
