         ...
         <div class="container">
            <div class="row d-flex align-items-center">
               <div class="col-lg-6 col-md-6">
                 ...
                 Site Kullanım Koşulları Çerez Politikası
               </h4></div>
               <div class="col-lg-6 col-md-6 text-right">
                  <div class="breadcrumbs">
                     <p class="mb-0"><a href="<?php echo $url;?>">
					 <i class="icofont-ui-home"></i> Anasayfa</a>  /  
					 <span>Site Kullanım Koşulları Çerez Politikası</span></p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
							...
							<h5 class="about-title" style="text-align: center;margin: 10px;">Site Kullanım Koşulları Çerez Politikası</h5>
