...
<div class="module so-extraslider-ltr product-simple col-extra">
	...
	<div class="modcontent">
			...
			<div  style="background: white;" id="so_extra_slider_4132828171633695852" class="so-extraslider buttom-type1 preset00-1 preset01-1 preset02-1 preset03-1 preset04-1 button-type1">
       ...
       <?php } ?>
		...
		<div class="content-product-mainheader clearfix"> 
			<div class="row" style="background: white;">	
						<div class="content-product-left  col-md-5 col-sm-12 col-xs-12" style="background: white;
padding: 15px;">
...
<div id="thumb-slider" class="full_slider  contentslider" data-rtl="no" data-autoplay="no"  data-pagination="no" data-delay="4" data-speed="0.6" data-margin="5"  data-items_column0="4" data-items_column1="3" data-items_column2="5" data-items_column3="3" data-items_column4="2" data-arrows="yes" data-lazyload="yes" data-loop="no" data-hoverpause="yes">
		...
		<a data-index="0" class="img thumbnail " data-image="resimler/urunler/<?php echo $page['resim']; ?>">
...
//--></script>
						...
						<div class="content-product-right col-md-7 col-sm-12 col-xs-12" style="background: white;
padding: 15px;">
...
font-weight: 500;" id="sonfiyat"><?php echo $yenifiyat;?></span>
            ...
            <form action="" method="POST">
			  ...
			  max-width: 100%;margin:0px !important;" name="sepetle"  class="btn btn-checkout "/><i class="fa fa-shopping-bag"></i> Sepete Ekle</button>
							<?php } else { ?>
                            <input type="button" style="width: 100%;
			  max-width: 100%;"  value="Tükendi" class="btn btn-checkout "/>
							<?php } ?>
...
font-size: 16px; text-transform: capitalize;" target="_blank" href="tel:<?php echo $ayar['ceptel']; ?>" class="urunmobilbuton butonok btn btn-primary btn-lg"><span> <i class="fa fa-phone"></i> Telefon İle Satın Al</span></a>
              <?php } ?>
...
margin-bottom: 2px !important;
font-size: 16px; text-transform: capitalize;max-width: 100%;" target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo $ayar['whatsapp']; ?>&amp;text=<?php echo $page['adi']; ?>%20sipari%C5%9Fi%20vermek%20istiyorum. <?php echo $url;?>/urun/<?php echo $page['seo']; ?>" class="urunmobilbuton butonok btn btn-primary btn-lg"><span><i class="fa fa-whatsapp"></i> WhatsApp ile Satın Al</span></a>
              <?php } ?>
...
<div class="clearfix related-horizontal " style="background: white;padding:15px;">
    ...
    <div class="related-products products-list  contentslider" data-rtl="no" data-autoplay="no" data-pagination="yes" data-arrows="no" data-delay="4" data-speed="0.6" data-margin="30"  data-items_column0="4" data-items_column1="3" data-items_column2="3"
		...
		<!-- Products list -->
            ...
            <div class="product-layout product-grid" style="border: 1px solid #f2ecec;background: white;">
