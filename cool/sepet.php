...
$karsilz = $ip;
$silxz = $ozy->prepare("DELETE FROM sepet WHERE kim=?, gelenkim=?");
$silxz->execute(array($karsilz,$sepetimdekikim));
	...
	<div class="form-group">
		...
		<div class="input-group">
			...
			<span class="input-group-append"> 
				<button class="btn btn-primary" style="width: 100%;background:<?php echo $tema['t8'];?>; !important;color:white;margin: 0px;font-size: 13px !important;" type="submit" name="kuponguncelle">Kupon Güncelle</button>
			</span>
		</div>
	</div>
	</form>
...
<div class="card-body">
		...
		<a href="anasayfa" style="color:white;" class="btn btn-light btn-block">ALIŞVERİŞE DEVAM</a>
</div> <!-- card-body.// -->
</div> <!-- card.// -->
