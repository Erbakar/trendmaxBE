...
<meta property="og:description" content="<?php echo $ayar['sitedesc']; ?>"/>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_pd00  col-style" style="background: white;
padding: 20px;">
  <script>
    //<![CDATA[
    	var listtabs1352150 = [];
  ...
  <div class="module so-listing-tabs-ltr listingtab-layout1 listtab-custom">
    <h3 class="modtitle"><span>Favori Ürünlerim</a></span></h3>
	...
	$__URUN__ = false;
        ...
        $__URUN__ = true;
                      ...
                      <div class="product-layout transition product-grid urunduzen" style="border: 1px solid #f2ecec;background: white;">
			...
			<?php } ?>
                            ...
                            <div class="button-group">
							  ...
							  ><i class="icom-compare"></i></button>
							   <button type="button" class="addToCart btn-button" title="Karşılaştırma Listeme Ekle" 
							  onclick="javascript:location.href='?favorilsil=<?php echo $katurunler['id']; ?>'"
