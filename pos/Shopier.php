...
class Shopier
	{
		...
		public function setBuyer($fields = Array())
		{
			$this->buyerValidateAndLoad($this->buyerFields(), $fields);
		}
		public function setOrderBilling($fields = Array())
		{
			$this->buyerValidateAndLoad($this->orderBillingFields(), $fields);
		}
		public function setOrderShipping($fields = Array())
		{
...
' . $form . '
    <body>
     ...
     ';
		...
		private function recursiveHtmlStringGenerator( $elements = Array(), $string = null)
		{
		...
		private function getCurrency()
		{
			...
			$Dil = strtoupper($this->currency);
			if(isset($currencyList[$Dil])) {
				return $currencyList[$Dil];
			}else{
				return 0;
			}
		}
