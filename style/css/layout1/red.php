...
body.preloader:before {
  ...
  height: 100%;
  z-index: 99998;
  background: url(<?php echo $sitetemasi;?>/images/loading.svg) no-repeat center center rgba(255, 255, 255, 0.9); }
    ...
    .item-article .nav-tabs .dropdown-menu {
      ...
      .item-article .nav-tabs > li.active > a, .item-article .nav-tabs > li.active > a:hover, .item-article .nav-tabs > li.active > a:focus {
        ...
        .item-article .nav-tabs > li.active > a:before, .item-article .nav-tabs > li.active > a:hover:before, .item-article .nav-tabs > li.active > a:focus:before {
          border: 10px solid <?php echo $tema['t8']; ?>;
          border-color: <?php echo $tema['t8']; ?> transparent transparent transparent;
          content: "";
          position: absolute;
          top: 100%;
          left: 50%;
...
/*============ BREADCRUMB ==================*/
.breadcrumbs {
  /*background: url(<?php echo $sitetemasi;?>/images/bg-breadcrumbs.jpg) no-repeat; 
   min-height: 190px;
   position: relative;
   margin-bottom: 40px;
...
#wrapper .so-groups-sticky {
  ...
  #wrapper .so-groups-sticky > a {
    ...
    height: 42px;
    padding: 15px;
    background: url(<?php echo $sitetemasi;?>/images/icon/icon-tools.png) no-repeat center 0; }
    ...
    #wrapper .so-groups-sticky > a:hover {
      background: url(<?php echo $sitetemasi;?>/images/icon/icon-tools-w.png) no-repeat center 0; }
...
body #so_popup_countdown .modal-footer #so_countdown_timer {
  ...
  body #so_popup_countdown .modal-footer #so_countdown_timer .time-item {
    ...
    body #so_popup_countdown .modal-footer #so_countdown_timer .time-item .num-time {
      ...
      font-weight: 500;
      padding: 0 10px;
      background: url(<?php echo $sitetemasi;?>/images/bg-count.png) repeat-x;
      border-radius: 3px;
      min-width: 70px; }
      ...
      .store_location .locations .tab-promotions .nav-tabs .item {
        ...
        .store_location .locations .tab-promotions .nav-tabs .item > a {
          ...
          .store_location .locations .tab-promotions .nav-tabs .item > a:after {
            ...
            border-left: 20px solid <?php echo $tema['t8']; ?>;
    ...
    .item-article ul.yt-accordion .yt-accordion-group .accordion-heading {
      ...
      .item-article ul.yt-accordion .yt-accordion-group .accordion-heading.active {
        ...
        .item-article ul.yt-accordion .yt-accordion-group .accordion-heading.active:before {
          border: 8px solid <?php echo $tema['t8']; ?>;
          border-color: <?php echo $tema['t8']; ?> transparent transparent transparent;
          content: "";
          position: absolute;
          top: 100%;
  ...
  .page-aboutus .spotlight ul {
    ...
    .page-aboutus .spotlight ul li {
      ...
      .page-aboutus .spotlight ul li .icon {
        width: 65px;
        height: 55px;
        background: url(<?php echo $sitetemasi;?>/images/icon/about-icon.png) no-repeat 7px 3px;
        margin: 0 auto;
        margin-bottom: 22px; }
...
.label-product-new, .label-new {
  background: url(<?php echo $sitetemasi;?>/images/icon/icon-new.png) no-repeat;
  width: 43px;
  height: 43px;
  font-weight: 700;
  font-size: 10px;
  ...
  .gallery-slider .owl2-controls .owl2-nav {
    ...
    .gallery-slider .owl2-controls .owl2-nav .owl2-prev, .gallery-slider .owl2-controls .owl2-nav .owl2-next {
      ...
      .gallery-slider .owl2-controls .owl2-nav .owl2-prev:hover, .gallery-slider .owl2-controls .owl2-nav .owl2-next:hover {
        background: url(<?php echo $sitetemasi;?>/images/id2-bg-title.jpg) no-repeat;
        border: none; }
    .gallery-slider .owl2-controls .owl2-nav .owl2-prev, .gallery-slider .owl2-controls .owl2-nav .owl2-next {
      border-radius: 3px;
      color: #fff; }
  ...
  .producttab .tabsslider.vertical-tabs ul.nav-tabs {
    ...
    .producttab .tabsslider.vertical-tabs ul.nav-tabs li {
      ...
      .producttab .tabsslider.vertical-tabs ul.nav-tabs li:before {
        ...
        z-index: 99; }
      .producttab .tabsslider.vertical-tabs ul.nav-tabs li:hover {
        border-left-color: <?php echo $tema['t8']; ?>; }
        .producttab .tabsslider.vertical-tabs ul.nav-tabs li:hover a {
          color: <?php echo $tema['t8']; ?>;
          border: none; }
...
.typeheader-4 .header-bottom {
  border-bottom: 2px solid <?php echo $tema['t8']; ?>; }
...
.listingtab-layout1-deal {
  ...
  .listingtab-layout1-deal .so-listing-tabs {
    ...
    .listingtab-layout1-deal .so-listing-tabs .wap-listing-tabs {
      /*! background: url(<?php echo $sitetemasi;?>/images/bg-tab1.jpg) no-repeat; */ }
    @media (min-width: 1200px) {
      .listingtab-layout1-deal .so-listing-tabs .wap-listing-tabs {
      ...
      .listingtab1 .owl2-controls .owl2-nav .owl2-prev, .listingtab1 .owl2-controls .owl2-nav .owl2-next {
        ...
        .listingtab1 .owl2-controls .owl2-nav .owl2-prev:hover, .listingtab1 .owl2-controls .owl2-nav .owl2-next:hover {
          ...
          .listingtab1 .owl2-controls .owl2-nav .owl2-prev:hover:before, .listingtab1 .owl2-controls .owl2-nav .owl2-next:hover:before {
            color: <?php echo $tema['t8']; ?>; }
    .listingtab1 .owl2-controls .owl2-dots {
      display: none !important; }
  ...
  @media (min-width: 767px) {
    .row-extra-trend .extra_trending .modtitle {
      ...
      .row-extra-trend .extra_trending .modtitle:before {
        ...
        border-left: 15px solid <?php echo $tema['t8']; ?>;
        position: absolute;
        top: 0px;
        right: -15px; }
