    ...
    <div id="content" class="col-md-9 col-sm-12 col-xs-12 fluid-sidebar">
      <div class="products-category clearfix">
		...
		?>						   
            ...
            <div class="product-layout product-grid product-grid-4 col-lg-3 col-md-4 col-sm-6 col-xs-12 urunduzen">
        ...
        <div class="product-filter product-filter-bottom filters-panel">
          <div class="row">
            ...
            <div class="col-sm-6 text-right"><?php echo ''.$katsay.''; ?> adet ürün</div>
          </div>
        </div>
