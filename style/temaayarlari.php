...
if (isset($_POST['guncelle'])) {
  ...
  $t50 = "display:none";
  $t49 = "Kategori Resmi - Bu temada kullanılamaz";
			     ...
			     <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                    <div class="card m-b-30">
		              ...
		              <input type="submit" name="submit" value="Temayı Yükle" class="btn btn-outline-primary waves-effect waves-light upload"> <br><br>
					   ...
					   <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Kampanyalar Altı Banner</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Kampanyalar Altı Banner Linki</label>
                                <div class="col-sm-10">
								...
								<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Kampanyalar Altı 2. Banner</label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Kampanyalar Altı 2. Banner Linki</label>
                                <div class="col-sm-10">
