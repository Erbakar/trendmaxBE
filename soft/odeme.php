...
padding: 10px;
border-radius: 6px;
font-size: 14px;">>Ödeme Detayları</h3><!-- End .summary-title -->
	                					...
	                					<tbody>
                                           ...
                                           <?php if($cekindirim!='0'){?>
	                						...
	                						<tr class="summary-total" >
	                							...
	                							<td id="toplam-price-val" style="color: #fa5616;font-size: 16px;font-weight: 500;"  data-price="<?php echo $toplamtutarim;?>"><?php echo $toplamtutari;?></td>
...
font-size: 14px;">>Ödeme Yöntemleri</h3><!-- End .summary-title -->
                                        ...
                                        <div id="paymentOptions">
                                         ...
                                         <i style="color: <?php echo $tema['t8']; ?>;"  class="fa fa-university" aria-hidden="true"></i> <span class="details credit">Havale/EFT</span>
                                         </li>
										 <?php } ?>
                                         ...
                                         <span class="radio"><input onclick="kapidaodemeekle(1)" type="radio" name="odemetipi" value="Kapıda Ödeme" required><label></label></span>
                                          <i style="color: <?php echo $tema['t8']; ?>;"  class="fa fa-truck" aria-hidden="true"></i> <span class="details credit">Kapıda Ödeme <b>+ <?php echo fiyatgoster($system['kapitutar']);?></b></span>
                                         </li>
										 <?php } ?>
                                         ...
                                         <span class="radio"><input onclick="kapidaodemeekle(0)" type="radio" name="odemetipi" value="Kredi Kartı" required><label></label></span>
                                          <i style="color: <?php echo $tema['t8']; ?>;"   class="fa fa-credit-card" aria-hidden="true"></i> <span class="details credit"> Kredi Kartı</span>
                                         </li>
										 <?php } ?>
