       ...
       foreach ($pr as $blog) {
        $__URUN__ = true;
                ...
                <div class="campaigns-page-card">
                    <div class="campaigns-page-card-image" style="background-image: url('resimler/haberler/<?php echo $blog['resim']; ?>') !important;"></div>
                    <span><?php echo $blog['adi']; ?></span>
                    <span class="campaigns-page-card-icon" onclick="location.href='blog/<?php echo $blog['seo']; ?>'">İncele</span> 
     ...
     <nav aria-label="Page navigation">
						...
						<?php $geri = $_GET['pages']-1;?>
                            <li class="page-item  <?php echo $_GET['pages'] == '1' ? 'disabled' : null; ?>">
                                <a class="page-link page-link-prev" href="blog/?pages=<?php echo $geri;?>" aria-label="Previous" tabindex="-1" aria-disabled="true">
                ...
                for ($i= $pages - $forlimit ; $i < $pages + $forlimit + 1 ; $i++) { 
                  ...
                  echo "<li class='page-item'><a class='page-link' href='blog/?pages=".$i."'>".$i."</a></li>";
                   ...
                   ?> 
							...
							<?php $ileri = 1+$_GET['pages'];?>
                                <a class="page-link page-link-next" href="blog/?pages=<?php echo $ileri;?>" aria-label="Previous" tabindex="-1" aria-disabled="true">
