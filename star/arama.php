  ...
  .notfound .notfound-404 h1>span {
    ...
    height: 86px;
                ...
                <div class="pagination-box bottom-padding-xp">
                  ...
                  echo "<li class='page-numbers'><a class='' href='arama/?pages=".$i.$eklenecekstr."'><span>".$i."</span></a></li>";
                  ...
                  <span class="pagination-text"><strong style="color: #ff0000;font-weight: 500;"><?php echo $arama;?></strong> kelimesine ait toplam <strong style="font-weight: 500;color: #ff0000"><?php $katsorgu = $ozy->prepare("SELECT COUNT(*) FROM urunler where durum='1' and $adi or $urunkodu or $aciklama");
