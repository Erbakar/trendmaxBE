            ...
            <div class="row">
              <div class="content col-sm-12 col-md-12">
				...
				<?php if($system['misafirok']=='1'){?>
				  ...
				  <div id="login-holder" class="col-xs-12 col-sm-4 col-md-4 box login" style="background:white !important;">
                    <form  class="form-box login-form form-validator bv-form" action="" method="POST" enctype="multipart/form-data" style="background: white !important;">
				      ...
				      <div id="login-holder" class="col-xs-12 col-sm-4 col-md-4 box login">
                    <form style="height: 606px;"  class="form-box login-form form-validator bv-form" action="" method="POST" enctype="multipart/form-data">
                    	<input type="hidden" name="nereden" value="anauyelik"/>
                      <div class="title-box">
                        <h2 class="h1 title">Misafir Alışverişi</h2>
                      </div>
                      <div class="row bottom-padding-xs">
...
padding: 15px;
margin: 8px 0;
font-size: 18px;" href="odeme/" class="btn btn-success">Üyeliksiz Devam Et</a>
						</div>
                        </div>
