...
if (isset($_POST['guncelle'])) {
  ...
  $t14 = ($_POST['t14'] != "") ? $_POST['t14'] : "0";
  $t50 = "display:none";
  $t49 = "Kategori Resmi";
  $t48 = "Kategori Anasayfa İkon Resmi";
  $t47 = "Kategori Anasayfa Resmi";
  $t16 = ($_POST['t16'] != "") ? $_POST['t16'] : "0";
  ...
  $temakonumv7 = $_FILES['t15']['tmp_name'];
  $temaadv7 = $_FILES['t15']['name'];
  $tematipv7 = $_FILES['t15']['type'];
  $tuzanti7 = substr($temaadv7, -5, 5);
  $t15 =  md5($temaadv7) . $tuzanti7;
  $temav6yol = "../resimler/temaayarlari";
  ...
  if (!empty($_FILES['t15']['name'])) {
        if ($tematipv7 != 'image/gif' && $tematipv7 != 'image/jpeg' && $tematipv7 != 'image/png' && $tuzanti7 != '.jpg' && $tuzanti7 != '.png' && $tuzanti7 != '.jpeg' && $tuzanti7 != '.gif') {
            echo '<script type="text/javascript">$(document).ready(function(){toastr["error"]("Lütfen ! Jpg ve Png uzantılı resim yükleyiniz ....", "Başarısız");});</script>';

        } else {
            $temav7 = move_uploaded_file($temakonumv7, $temav7yol . '/' . $t15);
            $temav7 = $ozy->prepare("update temalar set t15=? where id='$id'");
            $temav7->execute(array($t15));
		}
   ...
   $stmt = $ozy->prepare("UPDATE temalar SET t4 = ?, t5 = ?, t6 = ?, t7 = ?, t8 = ?, t10 = ?, t11 = ?, t13 = ?, t50 = ?, t49 = ?, t48 = ?, t47 = ?, t14 = ?, t16 = ? WHERE id = ?");
   $result2 = $stmt->execute(array($t4, $t5, $t6, $t7, $t8, $t10, $t11, $t13, $t50, $t49, $t48, $t47, $t14, $t16, $id));
			     ...
			     <form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                    <div class="card m-b-30">
		              ...
		              <input type="submit" name="submit" value="Temayı Yükle" class="btn btn-outline-primary waves-effect waves-light upload"> <br><br>
						   ...
						   <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Tema Üst Slogan</label>
                                <div class="col-sm-10">
					...
					<div class="form-group row">
                                <label for="example-color-input" class="col-sm-2 col-form-label">Tema 2. Rengi</label>
                                <div class="col-sm-10">
                                    <input class="form-control" name="t16" type="color" value="<?php echo $sayfam['t16']; ?>" id="example-color-input">
                                </div>
                            </div>
					
					   <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Slider Altı Banner</label>
                                <div class="col-sm-10">
							...
							<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Slider Altı Banner Linki</label>
                                <div class="col-sm-10">
								...
								<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Slider Altı Sağ Banner</label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Slider Altı Sağ Banner Linki</label>
                                <div class="col-sm-10">
						...
						<div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Popüler Ürünler Üstü Banner</label>
                                <div class="col-sm-10">
                              ...
                              <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Popüler Ürünler Üstü Banner Linki</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="t14" value="<?php echo $sayfam['t14']; ?>">
                                </div>
                            </div>   
