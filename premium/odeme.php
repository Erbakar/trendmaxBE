...
background: white;
padding: 10px;">
		                			<h2 class="checkout-title" style="border-bottom: 1px solid #ece9e9;
text-align: center;
background: #f8f8f8;
padding: 10px;
...
font-size: 14px;margin-bottom:20px;">>Sipariş Detayları</h2><!-- End .checkout-title -->
                            ...
                            <label class="custom-control-label" for="register-policy"><a data-toggle="modal" data-target=".bannerformmodal">Mesafeli Satış Sözleşmesi Şartlarını</a> okudum ve kabul ediyorum *</label>
...
padding: 10px;">
								<div class="summary summary-cart" style="background: white !important;">
	                				<h3 class="summary-title" style="border-bottom: 1px solid #ece9e9;
text-align: center;
background: #f8f8f8;
...
font-size: 14px;padding: 8px;">>Ödeme Detayları</h3><!-- End .summary-title -->
	                					...
	                					<tbody>
                                           ...
                                           <?php if($cekindirim!='0'){?>
	                						...
	                						<tr class="summary-total" >
	                							...
	                							<td id="toplam-price-val" style="font-size: 16px;font-weight: 500;"  data-price="<?php echo $toplamtutarim;?>"><?php echo $toplamtutari;?></td>
		                			...
		                			<div class="summary">
		                				<h3 class="summary-title" style="margin-bottom: 20px;border-bottom: 1px solid #ece9e9;
text-align: center;
background: #f8f8f8;
padding: 10px;
border-radius: 6px;
font-size: 14px;">>Ödeme Yöntemleri</h3><!-- End .summary-title -->
                                        ...
                                        <div id="paymentOptions">
										 ...
										 <li>
                                         <span class="radio"><input onclick="kapidaodemeekle(2)" type="radio" name="odemetipi" value="Havale/EFT" required><label> <i style="color: <?php echo $tema['t8']; ?>;"  class="fa fa-university" aria-hidden="true"></i> <span class="details credit">Havale/EFT</span></label></span>
										 ...
										 <li>
                                         <span class="radio"><input onclick="kapidaodemeekle(1)" type="radio" name="odemetipi" value="Kapıda Ödeme" required><label><i style="color: <?php echo $tema['t8']; ?>;"  class="fa fa-truck" aria-hidden="true"></i> <span class="details credit">Kapıda Ödeme <b>+ <?php echo fiyatgoster($system['kapitutar']);?></b></span></label></span>
										 ...
										 <li>
                                         <span class="radio"><input onclick="kapidaodemeekle(0)" type="radio" name="odemetipi" value="Kredi Kartı" required><label><i style="color: <?php echo $tema['t8']; ?>;"   class="fa fa-credit-card" aria-hidden="true"></i> <span class="details credit"> Kredi Kartı</span></label></span>
		                				...
		                				<button type="submit" class="butonok btn btn-outline-primary-2 btn-order btn-block">
