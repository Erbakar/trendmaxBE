	                		...
	                		<div class="col-md-10 col-lg-10">
	                			<div class="tab-content">
								    <div class="tab-pane fade show active" id="tab-dashboard" role="tabpanel" aria-labelledby="tab-dashboard-link">
								    	...
								    	<br>
								    	Dilersen buradan <a href="#tab-orders" class="tab-trigger-link link-underline">tüm siparişlerini görebilir</a>, veya<a href="#tab-address" class="tab-trigger-link"> kayıtlı adreslerini görebilir veya düzenleyebilir </a>, veya <a href="#tab-account" class="tab-trigger-link">üyelik bilgilerini görüntüleyip güncelleyebilirsin.</a>.</p>
								    </div><!-- .End .tab-pane -->
