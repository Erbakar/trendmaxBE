                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 offset-lg-1">
                            <div class="about-text text-center">
                                ...
                                <a class="image-popup-no-margins" href="resimler/kampanyalar/<?php echo $page['resim']?>">
								<img class="lazyload"  data-src="resimler/kampanyalar/<?php echo $page['resim'];?>" alt="signature" class="mx-auto mb-5" <?php echo $page['resim'] == 'resimyok.jpg' ? 'style="display:none;"' : null; ?>>
                    ...
                    foreach($sayfaresimi as $genelresim){?>
						...
						<a class="image-popup-no-margins" href="resimler/genel/<?php echo $genelresim['sayfaresim'];?>">		
                              <img class="lazyload"  data-src="resimler/genel/<?php echo $genelresim['sayfaresim'];?>" alt="image" class="mx-auto mb-6"></div><!-- End .icon-box -->
                        </a>
