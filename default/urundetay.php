                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    ...
                                    foreach ($sayfaresimi as $genelresim) { ?>
                                        <a class="product-gallery-item"
                                            href="resimler/genel/<?php echo $genelresim['sayfaresim']; ?>"
                                            data-image="resimler/genel/<?php echo $genelresim['sayfaresim']; ?>"
                                            data-zoom-image="resimler/genel/<?php echo $genelresim['sayfaresim']; ?>">
                                            <img class="lazyload"
                                                data-src="resimler/genel/<?php echo $genelresim['sayfaresim']; ?>">
                                        </a>
                                    <?php } ?>
                            ...
                            <form action="" method="POST">
                                ...
                                foreach ($ozellik as $anaozellik) { ?>
                                    <div class="details-filter-row details-row-size">
                                        <label for="size"
                                            style="width: 100%;font-weight: 500;"><?php echo $anaozellik['adi']; ?> :</label>
                                        <div class="select-custom" style="width: 100%;">
                                            <select class="form-control varyantselect" onchange="detayfiyathesapla(this);"
                                                ...
                                                foreach ($ozellikalt as $anaozellikalt) { ?>
                                                    <option data-price="<?php echo KdvDahil($anaozellikalt['fiyat'], $ekkdv); ?>"
                            ...
                            <div class="product-details-footer">
                                ...
                                <div class="social-icons social-icons-sm">
                                    ...
                                    <a href="https://twitter.com/intent/tweet?url=<?php echo $url; ?>/urun/<?php echo $page['seo']; ?>"
                                        class="social-icon" title="Twitter" target="_blank"><i
                                            class="icon-twitter"></i></a>
                                    <a href="https://api.whatsapp.com/send?phone=<?php echo $ayar['whatsapp']; ?>&amp;text= Baksana ne buldum:) <?php echo $page['adi']; ?> <?php echo $url; ?>/urun/<?php echo $page['seo']; ?>"
                                        class="social-icon" title="WhatsApp" target="_blank"><i
                                            class="icon-whatsapp"></i></a>
                                    <a href="https://plus.google.com/share?url=<?php echo $url; ?>/urun/<?php echo $page['seo']; ?>"
                                        class="social-icon" title="Google Plus" target="_blank"><i
                                            ...
                                            <div class="col">
                                                ...
                                                if ($karakter_sayisi > '1') { ?>
                                                    <div class="review-action"
                                                        style="padding: 20px;border: 1px solid #f1ecec;border-radius: 4px;">
                                                        ...
                                                        <div class="comment">
                                                            ...
                                                            <div class="comment-body">
                                                                <div class="comment-user">
                                                                    ...
                                                                    <span
                                                                        class="comment-date"><?php echo $blogyorum['email']; ?></span>
