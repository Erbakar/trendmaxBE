...
<meta property="og:description" content="<?php echo $ayar['sitedesc']; ?>"/>
		   ...
		   <main class="main">
        	<div class="page-header text-center" style="background-image: url('<?php echo $sitetemasi;?>/assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title">Üye Girişi / Kayıt Ol<span>Anasayfa</span></h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
	                	...
	                	<div class="row">
									...
									<input type="hidden" name="nereden" value="anauyelik"/>
                                        ...
                                        <div class="form-footer">
											   ...
											   <a style="margin-left: 10% !important;margin-right: 10% !important;" href="sifremiunuttum/" class="forgot-link">Şifremi Unuttum ?</a>
